...
const {getTech,updateUserByemail,signupUser,loginUser,updateProfil,getUsersByEmail,getTechHelp,getUserById,getUsers,createUser, deleteUser,updateUser} =  require('../controllers/userController')
//login route
