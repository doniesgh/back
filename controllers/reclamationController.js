...
exports.updateReclamationStatus = async (req, res) => {
  ...
  try {
      ...
      const notification = await Notification.create({
        receiverId: '64f84b3cddb0db0d24e1ccc4',
        senderId: req.user._id,
        message: notificationMessage,
      });
      // Assuming sendNotificationToManager is defined and working correctly
      // sendNotificationToManager(notification);
...
exports.updateReclamationStatusReporte = async (req, res) => {
  ...
  try {
    ...
    console.log('Reclamation:', reclamation); // Log the reclamation object
...
exports.updateReclamationStatusFinal = async (req, res) => {
  ...
  try {
    ...
    const notificationMessage = `Finalisation de réclamation ${reclamationId} à ${newStatus}`;
    const notification = await Notification.create({
      receiverId: '64f84b3cddb0db0d24e1ccc4',
      senderId: req.user._id,
      message: notificationMessage,
