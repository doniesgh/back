...
const getTech = async (req, res) => {
  try {
    ...
    if (users.length > 0) {
      ...
      res.status(404).json({ message: 'No users found with the specified roles' });
    }
  } catch (error) {
...
module.exports = {getTech,updateUserByemail, updateProfil,getTechHelp,getUserByRole,NbClient,NbHelpDesk,NbTechnicien,loginUser, createUser,signupUser ,deleteUser,updateUser, getUsers , getUsersByEmail,getUserById}
